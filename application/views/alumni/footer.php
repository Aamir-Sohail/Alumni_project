...
<footer id="page-footer">
    <section id="footer-content">
        ...
        <div class="background" ><img style="width: 1400px; height: 350px" src="<?php echo base_url();  ?>assets/alumni/img/banner.jpg" class="" alt=""></div>
        ...
        <div class="container">
            <div class="footer-inner">
                <div class="copyright" align="center">
                    &copy;
                    <a href="<?php echo $this->db->get_where('setting', array('setting_id' => 9))->row()->content; ?>" target="_blank"><?php echo $this->db->get_where('setting', array('setting_id' => 3))->row()->content;; ?></a>
