...
<div id="content" class="content">
	...
	<div class="row">
		...
		<div class="col-md-6 offset-md-3">
			...
			<div class="panel panel-inverse">
				<?php if ($this->session->flashdata('success') && $this->session->flashdata('about_us_text')) : ?>
				...
				<?php endif; ?>
				<?php if ($this->session->flashdata('warning') && $this->session->flashdata('about_us_text')) : ?>
	...
	<div class="row">
		...
		<div class="col-md-6 offset-md-3">
			<!-- begin panel -->
			<div class="panel panel-inverse">
				<?php if ($this->session->flashdata('success') && $this->session->flashdata('about_us_image')) : ?>
					<div class="alert alert-success alert-dismissible fade show" role="alert">
						<button type="button" class="close" data-dismiss="alert" aria-label="Close">
							<span aria-hidden="true">×</span>
						</button>
				...
				<?php endif; ?>
				<?php if ($this->session->flashdata('warning') && $this->session->flashdata('about_us_image')) : ?>
					<div class="alert alert-warning alert-dismissible fade show" role="alert">
						<button type="button" class="close" data-dismiss="alert" aria-label="Close">
							<span aria-hidden="true">×</span>
						</button>
	...
	<div class="row">
		...
		<div class="col-md-6 offset-md-3">
			<!-- begin panel -->
			<div class="panel panel-inverse">
				<?php if ($this->session->flashdata('tc_success')): ?>
					<div class="alert alert-success alert-dismissible fade show" role="alert">
						<button type="button" class="close" data-dismiss="alert" aria-label="Close">
							<span aria-hidden="true">×</span>
						</button>
						<?php echo $this->session->flashdata('tc_success'); ?>
					</div>
				<?php endif; ?>
				<div class="panel-body">
					<?php echo form_open_multipart('admin/about_us/update_tc', array('data-parsley-validate' => 'true', 'name' => 'update_image')); ?>
					<div class="form-group">
						<label class="col-md-12 col-form-label"><?php echo $this->lang->line('terms_and_conditions'); ?></label>
						<div class="col-md-12">
							<textarea class="summernote" name="terms_and_conditions" data-parsley-required="true"><?php echo $this->db->get_where('about_us', array('about_us_id' => 1))->row()->terms_and_conditions; ?></textarea>
						</div>
					</div>
