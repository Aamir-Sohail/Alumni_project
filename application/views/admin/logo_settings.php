...
<div id="content" class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="panel panel-inverse">
                <?php if ($this->session->flashdata('success') && $this->session->flashdata('favicon')) : ?>
                ...
                <?php endif; ?>
                <?php if ($this->session->flashdata('warning') && $this->session->flashdata('favicon')) : ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6 offset-md-3">
            <!-- begin panel -->
            <div class="panel panel-inverse">
                <?php if ($this->session->flashdata('success') && $this->session->flashdata('header_logo')) : ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                ...
                <?php endif; ?>
                <?php if ($this->session->flashdata('warning') && $this->session->flashdata('header_logo')) : ?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
    ...
    <div class="row">
        ...
        <div class="col-md-6 offset-md-3">
            <!-- begin panel -->
            <div class="panel panel-inverse">
                <?php if ($this->session->flashdata('success') && $this->session->flashdata('footer_logo')) : ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                ...
                <?php endif; ?>
                <?php if ($this->session->flashdata('warning') && $this->session->flashdata('footer_logo')) : ?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
