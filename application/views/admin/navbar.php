...
<div id="sidebar" class="sidebar" data-disable-slide-animation="true">
	...
	<div data-scrollbar="true" data-height="100%">
		...
		<ul class="nav">
			...
			<li class="has-sub <?php if ($page_name == 'add_alumnus' || $page_name == 'alumni' || $page_name == 'email_alumni' || $page_name == 'payment_methods') echo 'active'; ?>">
				<a href="javascript:;">
			...
			<li class="<?php if ($page_name == 'permission_requests') echo 'active'; ?>">
				<a href="<?php echo base_url(); ?>admin/permission_requests">
					<i class="fa fa-lock"></i>
					<span><?php echo $this->lang->line('permission_requests'); ?></span>
				</a>
			</li>
			...
			<li class="has-sub <?php if ($page_name == 'website_settings' || $page_name == 'profession_settings' || $page_name == 'admin_settings' || $page_name == 'logo_settings' || $page_name == 'bg_settings') echo 'active'; ?>">
				<a href="javascript:;">
					<b class="caret pull-right"></b>
					<i class="fa fa-cog"></i>
