...
<?php echo form_open('admin/notices/edit/' . $row['notice_id'], array('data-parsley-validate' => 'true', 'name' => 'update_text')); ?>
	...
	<div class="form-group">
        ...
        <textarea style="resize: none" rows="10" class="form-control" type="text" name="description" placeholder="<?php echo $this->lang->line('ph_notice_description'); ?>" data-parsley-required="true"><?php echo $row['description']; ?></textarea>
    </div>
