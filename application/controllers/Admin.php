...
class Admin extends CI_Controller
{
    ...
    public function slides($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function alumni($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function stories($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin' && $this->session->userdata('auth_kind') != 'alumnus') {
            redirect(base_url('admin/login'), 'refresh');
        }
        ...
        if ($this->session->userdata('auth_kind') == 'alumnus') {
            ...
            if ($has_story_permission) {
                if ($param1 == 'add') {$this->admin_crud->add_story();} elseif ($param1 == 'edit') {$this->admin_crud->edit_story($param2);} elseif ($param1 == 'change_story_image') {$this->admin_crud->change_story_image($param2);} elseif ($param1 == 'delete') {$this->admin_crud->delete_story($param2);}
    ...
    public function permission_requests($param1 = '', $param2 = '')
    {
        if ($param1 == 'edit') {
    ...
    public function comment($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function albums($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function edit_gallery($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function volunteers($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function manage_donation_purposes($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function donations($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function message($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function profession_settings($param1 = '', $param2 = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
        ...
        if ($param1 == 'add') {
            $this->admin_crud->add_profession();
        } elseif ($param1 == 'update') {
            $this->admin_crud->update_profession($param2);
        }
    ...
    public function logo_settings($param = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function bg_settings($param = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
    ...
    public function admin_settings($param = '')
    {
        if ($this->session->userdata('auth_kind') != 'admin') {
            redirect(base_url() . 'admin/login', 'refresh');
        }
