...
class United_crud extends CI_Model
{
    ...
    public function get_alumni_batch($batch = '')
    {
        $data = [];
        if ($batch == 'all') {
    ...
    public function select_alumnus_chat($alumnus_id = '')
    {
        $data = [];
        $chat = [];
        $chat1 = $this->db->get_where('chat', array('receiver_id' => $alumnus_id, 'sender_id' => $this->session->userdata('alumnus_id')))->result_array();
        $chat2 = $this->db->get_where('chat', array('sender_id' => $alumnus_id, 'receiver_id' => $this->session->userdata('alumnus_id')))->result_array();
    ...
    public function save_message($alumnus_id = '')
    {
    ...
    public function story_view_count($param = '')
    {
    ...
    public function update_rsvp($event_id = '', $rsvp = '', $alumnus_id = '')
    {
    ...
    public function paginate($page_name, $db_name, $per_page)
    {
    ...
    public function paginate_alumni()
    {
    ...
    public function paginate_batchmates()
    {
    ...
    public function paginate_deceased()
    {
    ...
    public function paginate_volunteers()
    {
    ...
    public function update_volunteer_password($param = '')
    {
...
//impotant for login....
    ...
    public function update_alumnus_password($param = '')
    {
    ...
    public function update_alumnus_miscellaneous_public($param = '')
    {
    ...
    public function update_alumnus_miscellaneous_permissions($param = '')
    {
